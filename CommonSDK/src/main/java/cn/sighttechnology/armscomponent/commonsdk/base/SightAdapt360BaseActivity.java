 ...
 */
public abstract class SightAdapt360BaseActivity<P extends IPresenter>
     ...
     * 头条适配方案 宽度定义
     */
    public static final int DESIGN_WIDTH_IN_PIXEL = 360;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /**
         * 以360px的屏幕宽度作适配 （此方法只能在调用 setContentView 方法前调用）
         */
        ScreenUtils.adaptScreen4VerticalSlide(this, DESIGN_WIDTH_IN_PIXEL);
        ...
        //透明深色
        SdkSightUtils.setStatusColor(this, Color.TRANSPARENT, true);
    ...
    protected void onDestroy() {
        super.onDestroy();
        PgyCrashManager.unregister();//解除蒲公英
...
//        setRefreshHeaderAndFooter();
    ...
    /**
     * SmartRefreshLayout刷新、加载组件 的全局头部、底部生成器配置
     */
