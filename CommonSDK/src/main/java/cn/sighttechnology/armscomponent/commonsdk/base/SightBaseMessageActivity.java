 ...
 */
public abstract class SightBaseMessageActivity<P extends IPresenter> extends UmengNotifyClickActivity implements IActivity, ActivityLifecycleable {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PgyCrashManager.register(this);//注册蒲公英
