...
public class AutoRelativeLayout extends RelativeLayout {
    ...
    public AutoRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
