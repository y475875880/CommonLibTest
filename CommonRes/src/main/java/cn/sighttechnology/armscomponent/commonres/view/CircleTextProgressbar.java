...
public class CircleTextProgressbar extends TextView {
     ...
     * 进度条的宽度。
     */
    private int progressLineWidth = 20;
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.public_CircleTextProgressbar);
        if (typedArray.hasValue(R.styleable.public_CircleTextProgressbar_public_in_circle_color))
            inCircleColors = typedArray.getColorStateList(R.styleable.public_CircleTextProgressbar_public_in_circle_color);
        else
